...
<div class="flex flex-col items-center gap-5">
    <div class="relative shrink-0" style="width: {{ $size }}; height: {{ $size }};">
        <div class="w-full h-full rounded-full shadow-lg shadow-violet-500/10" style="background: {{ $gradient }};"></div>
        <div class="absolute inset-[14%] rounded-full bg-[#0f0a1e] border border-white/10 flex flex-col items-center justify-center text-center px-2">
