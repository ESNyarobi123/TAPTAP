    ...
    <div class="glass-card rounded-2xl overflow-hidden border border-white/10">
        <div class="p-6 border-b border-white/5">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                ...
                <a href="{{ route('admin.restaurants.create') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-fin-primary to-fin-primary-dark text-white rounded-xl font-semibold text-sm shrink-0 hover:shadow-lg hover:shadow-violet-500/25 transition-all">
