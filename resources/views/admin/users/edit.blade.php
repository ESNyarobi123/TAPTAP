        ...
        <div class="glass-card rounded-2xl p-8">
            ...
            <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-6">
                ...
                <div class="flex items-center justify-end gap-4 pt-6">
                    ...
                    <button type="submit" class="px-8 py-4 bg-gradient-to-r from-fin-primary to-fin-primary-dark text-white rounded-xl font-bold text-sm hover:shadow-lg hover:shadow-violet-500/25 transition-all">Update User</button>
                </div>
            </form>
        </div>
    </div>
