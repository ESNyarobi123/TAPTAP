...
<head>
    ...
    <style>
        ...
        .text-hero-gradient {
            background: linear-gradient(120deg, #12141C 0%, #6D52E8 45%, #8C71F6 85%);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
        }
        .text-hero-accent {
            background: linear-gradient(90deg, #6D52E8, #8C71F6, #A78BFA);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
        }
        .nav-glass {
            ...
            box-shadow: 0 8px 32px rgba(18,20,28,0.06), 0 0 0 1px rgba(140,113,246,0.06);
        }
        .nav-glass.scrolled {
            box-shadow: 0 12px 40px rgba(109,82,232,0.12);
        }
        .btn-glow {
            background: linear-gradient(135deg, #8C71F6 0%, #6D52E8 100%);
            box-shadow: 0 4px 20px rgba(109,82,232,0.4), 0 0 0 1px rgba(255,255,255,0.15) inset;
            transition: transform 0.25s ease, box-shadow 0.25s ease;
        }
        .btn-glow:hover {
            transform: translateY(-2px);
            box-shadow: 0 8px 32px rgba(109,82,232,0.5);
        }
        .section-label {
            display: inline-flex;
            align-items: center;
            ...
            color: #6D52E8;
            background: linear-gradient(135deg, rgba(237,233,254,0.9), rgba(255,255,255,0.9));
            border: 1px solid rgba(140,113,246,0.2);
        }
        .fin-card {
            background: #fff;
            border: 1px solid rgba(18,20,28,0.06);
            box-shadow: 0 4px 24px rgba(18,20,28,0.04);
            transition: transform 0.4s cubic-bezier(0.22,1,0.36,1), box-shadow 0.4s ease, border-color 0.3s ease;
        }
        .fin-card:hover {
            transform: translateY(-6px);
            border-color: rgba(140,113,246,0.25);
            box-shadow: 0 20px 50px rgba(109,82,232,0.12);
        }
        .stat-card {
            background: linear-gradient(145deg, #fff 0%, #FAFAFE 100%);
            border: 1px solid rgba(140,113,246,0.12);
        ...
        .stat-card::before {
            ...
            height: 3px;
            background: linear-gradient(90deg, #8C71F6, #C6BDFA);
        }
        .stat-number {
            font-size: 2.25rem;
            font-weight: 300;
            letter-spacing: -0.03em;
            background: linear-gradient(135deg, #6D52E8, #8C71F6);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
        }
        ...
        .feature-card-lg {
            background: linear-gradient(160deg, #fff 0%, #FAFAFE 50%, #F5F3FF 100%);
        }
        .phone-float {
        ...
        @media (min-width: 768px) {
            .step-line::after {
                ...
                width: calc(100% - 4rem);
                height: 2px;
                background: linear-gradient(90deg, #DDD7FE, #8C71F6, #DDD7FE);
            }
            .step-line:last-child::after { display: none; }
        }
        .pricing-featured {
            background: linear-gradient(180deg, rgba(237,233,254,0.6) 0%, #fff 40%);
            border: 2px solid rgba(140,113,246,0.35);
            box-shadow: 0 24px 60px rgba(109,82,232,0.15);
        }
        .testimonial-card {
            background: #fff;
            border: 1px solid rgba(18,20,28,0.06);
            ...
            padding: 1.75rem;
            box-shadow: 0 8px 30px rgba(18,20,28,0.04);
        }
        .footer-dark {
            background: linear-gradient(180deg, #12141C 0%, #1a1d28 100%);
            color: #94A3B8;
        }
        ...
        <div class="flex items-center justify-between gap-4">
            <a href="/" class="flex items-center gap-2.5 group">
                <div class="h-9 w-9 rounded-xl bg-gradient-to-br from-fin-primary to-fin-primary-dark p-1.5 shadow-md shadow-fin-primary/25 group-hover:scale-105 transition-transform">
                    <img src="{{ public_asset('images/logo.png') }}" alt="TIPTAP" class="h-full w-full object-contain rounded-lg bg-white">
                </div>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-14 lg:gap-10">
                <div class="flex-1 text-center lg:text-left max-w-xl mx-auto lg:mx-0">
                    <div class="inline-flex items-center gap-2 rounded-full pl-1 pr-4 py-1 mb-8 bg-white/70 backdrop-blur-md border border-white shadow-sm">
                        ...
                        <span class="text-xs font-medium text-fin-muted">TipTap Rafiki · WhatsApp · QR · M-Pesa</span>
                    </div>
    ...
    <section id="features" class="py-20 lg:py-28 bg-fin-surface">
        <div class="max-w-6xl mx-auto px-5">
            <div class="text-center max-w-2xl mx-auto mb-16 reveal">
                ...
                <p class="text-fin-muted mt-5 text-base leading-relaxed">QR tables, WhatsApp bot, payments, kitchen screen, and manager dashboard — one beautiful platform.</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-12 gap-5">
                <div class="fin-card feature-card-lg rounded-3xl p-8 md:col-span-7 reveal">
                    ...
                    <p class="text-fin-muted leading-relaxed max-w-md text-[0.95rem]">Customers browse your menu, order, request the bill, and pay — all inside one chat. English and Swahili supported.</p>
                ...
                <div class="fin-card rounded-3xl p-8 md:col-span-7 reveal overflow-hidden">
                    <div class="flex flex-col sm:flex-row gap-8">
                        ...
                        <div class="flex-1 rounded-2xl bg-gradient-to-br from-fin-ink to-[#2a2d3a] p-5 text-white font-mono text-xs shadow-xl">
                            ...
                            <p class="opacity-90">2× Grilled Fish</p>
                            <p class="opacity-70">1× Chips Masala</p>
                            <p class="text-fin-lavender mt-3 text-[10px]">Table 12 · James</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 lg:py-20 bg-fin-mist/50 border-y border-fin-primary/5">
        <div class="max-w-6xl mx-auto px-5">
            ...
            <div class="grid md:grid-cols-3 gap-5">
                @foreach([
                    ['"Queues dropped — guests now order themselves on WhatsApp."', 'Manager, Dar es Salaam'],
                    ...
                    <blockquote class="testimonial-card reveal">
                        <p class="text-fin-ink text-[0.95rem] leading-relaxed font-medium">{{ $quote }}</p>
    ...
    <footer class="footer-dark pt-16 pb-10">
        <div class="max-w-6xl mx-auto px-5">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-4 pt-8 border-t border-white/10 text-sm text-slate-500">
                <p>© {{ date('Y') }} TIPTAP. All rights reserved.</p>
